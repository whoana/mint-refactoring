...
/**
 * Created by Solution TF on 15. 8. 31..
 */
public class DatabaseServiceException extends Exception {
    ...
    public DatabaseServiceException(String s) {
        super(s);
    }

    public DatabaseServiceException(String s, Throwable throwable) {
        super(s, throwable);
    }

    public DatabaseServiceException(Throwable throwable) {
        super(throwable);
    }
}
