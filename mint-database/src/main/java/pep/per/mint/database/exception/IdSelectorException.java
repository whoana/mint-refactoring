 ...
 */
public class IdSelectorException extends Exception {


    public IdSelectorException() {
        super();
    }

    public IdSelectorException(String s) {
        super(s);
    }

    public IdSelectorException(String s, Throwable throwable) {
        super(s, throwable);
    }

    public IdSelectorException(Throwable throwable) {
        super(throwable);
    }
}
