...
public class BrokerInfo extends CacheableObject {
	...
	/**
	 * @param serviceGroupList the serviceGroupList to set
	 */
	...
	/**
	 * @param listenerGroup the listenerGroup to set
	 */
	public void setListenerGroup(ListenerGroup listenerGroup) {
