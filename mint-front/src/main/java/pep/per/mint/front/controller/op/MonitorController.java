...
public class MonitorController {
	...
	@RequestMapping(value = "/tracking/logs", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
     ...
     */
	@RequestMapping(
			value="/tracking/logs/{logKey1}/{logKey2}", params={"method=GET"}, method=RequestMethod.POST, headers="content-type=application/json")
     ...
     */
	@RequestMapping(
			value="/tracking/diagrams/{logKey1}/{logKey2}", params={"method=GET"}, method=RequestMethod.POST, headers="content-type=application/json")
