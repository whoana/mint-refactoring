...
import pep.per.mint.front.excel.tools.excel.xlsx.SimpleXLSXWorkbook.ModifyEntry;
import pep.per.mint.front.excel.tools.excel.xlsx.SimpleXLSXWorkbook.XMLStreamCreator;
...
public class Sheet {
	...
	public static class SheetRowReader {
		public final static int MAX_COLUMN_SPAN = (('Z' - 'A') + 1) * 5;
