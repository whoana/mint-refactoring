...
import pep.per.mint.database.service.op.QAMonitorService;
...
@Controller
@RequestMapping("/op")
public class QAMonitorController {
	private static final Logger logger = LoggerFactory.getLogger(QAMonitorController.class);
	...
	@Autowired
	QAMonitorService monitorService;
	...
	@RequestMapping(value = "/qa/tracking/logs", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
     ...
     */
	@RequestMapping(
			value="/qa/tracking/logs/{logKey1}/{logKey2}", params={"method=GET"}, method=RequestMethod.POST, headers="content-type=application/json")
     ...
     */
	@RequestMapping(
			value="/qa/tracking/diagrams/{logKey1}/{logKey2}", params={"method=GET"}, method=RequestMethod.POST, headers="content-type=application/json")
