      ...
      this.select = function () {
        ...
        if (agent.isW3CRangeSupport) {
          ...
          if (selection.rangeCount > 0) {
            ...
            //2015-11-24 mksong
			//summernote 이미지 팝업에서 다른 영역 클릭시 에러 발생하는 부분 주석처리
      ...
      return '<div class="' + className + ' modal" aria-hidden="false">' +
               '<div class="modal-dialog-original">' +
                 '<div class="modal-content-original">' +
                   ...
                   '<div class="modal-body-original">' + body + '</div>' +
                   (footer ?
                   '<div class="modal-footer-original">' + footer + '</div>' : ''
                   ) +
                 '</div>' +
               '</div>' +
             '</div>';
...
//					2015-11-24 mksong
//					summernote 이미지 팝업에서 사용하지 않는 url 부분 제거
