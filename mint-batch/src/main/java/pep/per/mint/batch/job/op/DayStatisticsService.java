...
@Service
public class DayStatisticsService extends JobServiceCaller{

    @Autowired
    DayStatisticsJobMapper dayStatisticsJobMapper;

    @Transactional
    public void run(Map params) throws Exception{
    	dayStatisticsJobMapper.deleteSD(params);
    	dayStatisticsJobMapper.insertSD(params);
    }
