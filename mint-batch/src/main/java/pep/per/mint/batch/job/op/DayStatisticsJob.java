...
public class DayStatisticsJob implements Job{
    ...
    Logger log = LoggerFactory.getLogger(DayStatisticsJob.class);
    ...
    public void execute(JobExecutionContext context)
        ...
        try {
            ...
            sqlSession.delete("pep.per.mint.batch.mapper.op.DayStatisticsJobMapper.deleteSD", params);
            sqlSession.insert("pep.per.mint.batch.mapper.op.DayStatisticsJobMapper.insertSD", params);
