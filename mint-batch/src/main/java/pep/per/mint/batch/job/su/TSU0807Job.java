...
@Service
public class TSU0807Job implements Job{

    Logger log = LoggerFactory.getLogger(TSU0807Job.class);
	...
	public void execute(JobExecutionContext context)
        ...
        //String stDay = Util.join(Util.getFormatedDate(yesterday, "yyyyMMdd"));
        ...
        //params.put("stDay", stDay);
        params.put("fromDay", fromDay);
        params.put("toDay", toDay);
        params.put("regApp", "TSU0807Job");
        ...
        try {
            ...
            sqlSession.delete("pep.per.mint.batch.mapper.su.TSU080XJobMapper.deleteTSU0807", params);
            log.info(Util.join(Util.join("JOB[", jobName ,"] : 이전데이터 삭제 처리 OK")));
            log.info(Util.join(Util.join("JOB[", jobName ,"] : 집계")));
            sqlSession.insert("pep.per.mint.batch.mapper.su.TSU080XJobMapper.insertTSU0807", params);
