...
@Service
public class HourStatisticsJob implements Job{

    Logger log = LoggerFactory.getLogger(HourStatisticsJob.class);
    ...
    public void execute(JobExecutionContext context)
        ...
        try {
            ...
            sqlSession.delete("pep.per.mint.batch.mapper.op.HourStatisticsJobMapper.deleteSH", params);
            sqlSession.insert("pep.per.mint.batch.mapper.op.HourStatisticsJobMapper.insertSH", params);
