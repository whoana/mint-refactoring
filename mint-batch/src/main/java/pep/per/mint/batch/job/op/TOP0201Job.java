...
@Service
public class TOP0201Job implements Job{

    Logger log = LoggerFactory.getLogger(TOP0201Job.class);
	...
	public void execute(JobExecutionContext context)
        ...
        try {
            ...
            sqlSession.delete("pep.per.mint.batch.mapper.op.TOP0201JobMapper.deleteTOP0201", params);
            sqlSession.insert("pep.per.mint.batch.mapper.op.TOP0201JobMapper.insertTOP0201", params);
