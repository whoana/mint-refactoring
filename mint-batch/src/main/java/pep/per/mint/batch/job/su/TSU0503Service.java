...
import pep.per.mint.batch.mapper.su.TSU0503JobMapper;
...
@Service
public class TSU0503Service extends JobServiceCaller{

    Logger log = LoggerFactory.getLogger(TSU0503Service.class);

    @Autowired
    TSU0503JobMapper tsu0503JobMapper;
    ...
    public void run(Map params) throws Exception{
    	...
    	tsu0503JobMapper.deleteTSU0503(params);
    	tsu0503JobMapper.insertTSU0503(params);
    	tsu0503JobMapper.deleteTSU0504(params);
    	tsu0503JobMapper.insertTSU0504(params);
    }
