...
@Service
public class TSU0805Job implements Job{

    Logger log = LoggerFactory.getLogger(TSU0805Job.class);
	...
	public void execute(JobExecutionContext context)
        ...
        try {
            ...
            sqlSession.delete("pep.per.mint.batch.mapper.su.TSU080XJobMapper.deleteTSU0805", params);
            log.info(Util.join(Util.join("JOB[", jobName ,"] : 이전데이터 삭제 처리 OK")));
            log.info(Util.join(Util.join("JOB[", jobName ,"] : 집계")));
            sqlSession.insert("pep.per.mint.batch.mapper.su.TSU080XJobMapper.insertTSU0805", params);
