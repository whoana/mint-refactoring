...
@Service
public class TSU0803NHService extends JobServiceCaller{

	Logger log = LoggerFactory.getLogger(TSU0803NHService.class);
    ...
    public void run(Map params) throws Exception{
    	...
    	if(Util.isEmpty(toDate) || toDate.length() < 10) {
	     ...
	     try {
	         ...
	         List<Map<String,String>> interfaceList = srcSqlSession.selectList("pep.per.mint.batch.mapper.ifm.IfmNHJobMapper.selectInterfaces", params);
