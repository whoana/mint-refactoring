...
@Service
public class DetailLogErrorJob implements Job{

    Logger log = LoggerFactory.getLogger(DetailLogErrorJob.class);
    ...
    public void execute(JobExecutionContext context)
        ...
        try {
            ...
            List<Map> list = sqlSession.selectList("pep.per.mint.batch.mapper.op.DetailLogErrorJobMapper.selectDelayedTrLog", params);
            for (Map map : list) {
            	//sqlSession.insert("pep.per.mint.batch.mapper.op.DetailLogErrorJobMapper.insertDetailLogError", map);
            	sqlSession.update("pep.per.mint.batch.mapper.op.DetailLogErrorJobMapper.updateMasterlogStatus", map);
            }
