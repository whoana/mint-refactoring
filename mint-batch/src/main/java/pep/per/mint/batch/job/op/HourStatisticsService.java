...
import pep.per.mint.batch.mapper.op.HourStatisticsJobMapper;
...
@Service
public class HourStatisticsService extends JobServiceCaller{

    @Autowired
    HourStatisticsJobMapper hourStatisticsJobMapper;

    @Transactional
    public void run(Map params) throws Exception{
    	hourStatisticsJobMapper.deleteSH(params);
    	hourStatisticsJobMapper.insertSH(params);
    }
