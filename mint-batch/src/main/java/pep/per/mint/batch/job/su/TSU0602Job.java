...
@Service
public class TSU0602Job implements Job{

    Logger log = LoggerFactory.getLogger(TSU0602Job.class);
	...
	public void execute(JobExecutionContext context)
        ...
        try {
            ...
            sqlSession.delete("pep.per.mint.batch.mapper.su.TSU0602JobMapper.deleteTSU0602", params);
            sqlSession.insert("pep.per.mint.batch.mapper.su.TSU0602JobMapper.insertTSU0602", params);
