...
@Service
public class TSU0505Job extends JobImpl implements Job {

    Logger log = LoggerFactory.getLogger(TSU0505Job.class);
	...
	public void execute(JobExecutionContext context)
        ...
        try {
            ...
            sqlSession.delete("pep.per.mint.batch.mapper.su.TSU0505JobMapper.deleteTSU0505", params);
            sqlSession.insert("pep.per.mint.batch.mapper.su.TSU0505JobMapper.insertTSU0505", params);
