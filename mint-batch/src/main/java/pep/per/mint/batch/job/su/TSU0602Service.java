...
@Service
public class TSU0602Service extends JobServiceCaller{

    @Autowired
    TSU0602JobMapper tsu0602JobMapper;

    @Transactional
    public void run(Map params) throws Exception{
        tsu0602JobMapper.deleteTSU0602(params);
        tsu0602JobMapper.insertTSU0602(params);
    }
