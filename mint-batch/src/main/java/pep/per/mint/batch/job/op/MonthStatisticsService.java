...
import pep.per.mint.batch.mapper.op.MonthStatisticsJobMapper;
...
@Service
public class MonthStatisticsService extends JobServiceCaller{

    @Autowired
    MonthStatisticsJobMapper monthStatisticsJobMapper;

    @Transactional
    public void run(Map params) throws Exception{
    	monthStatisticsJobMapper.deleteSM(params);
    	monthStatisticsJobMapper.insertSM(params);
    }
