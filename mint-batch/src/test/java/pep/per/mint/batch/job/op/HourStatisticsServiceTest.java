...
public class HourStatisticsServiceTest {
	private static final Logger logger = LoggerFactory.getLogger(HourStatisticsServiceTest.class);
	...
	public void testService() {
		...
		try {
			...
			hourStatisticsService.run(params);
