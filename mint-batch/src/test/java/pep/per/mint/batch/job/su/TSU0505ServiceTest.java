...
public class TSU0505ServiceTest {
	private static final Logger logger = LoggerFactory.getLogger(TSU0505ServiceTest.class);
	...
	public void testService() {
		...
		try {
			...
			params.put("stDate", Util.join("20151106"));
			tsu0505Service.run(params);
