...
public class DayStatisticsServiceTest {
	private static final Logger logger = LoggerFactory.getLogger(DayStatisticsServiceTest.class);
	...
	public void testService() {
		...
		try {
			...
			dayStatisticsService.run(params);
