...
rem ------------------
set "CMD_OPTS=-Djava.library.path=%IIPAGENT_HOME%/lib  -DIIPAGENT_HOME=C:\WORK\IIP_V3\mint\mint-agent-boot\install\iipagent"
rem ------------------
rem set classpath
rem ------------------
...
rem run iip agent
rem ------------------
%JAVA_HOME%/bin/java %JAVA_OPTS% %CMD_OPTS% -classpath %CLASSPATH% pep.per.mint.agent.console.AgentManagementConsole -cmd %1
